  ...
  return (
    <div className="fixed bottom-6 right-5 z-50 flex flex-col items-center gap-3">
      ...
      <a
        ...
        className="flex h-12 w-12 items-center justify-center rounded-full bg-brand text-white shadow-lg transition-transform hover:-translate-y-0.5"
      >
      ...
      <a
        ...
        className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl transition-transform hover:-translate-y-0.5"
      >
